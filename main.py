...
def start_program():
    ...
    cv2.namedWindow("Webcog Draw Painting")
    cv2.setMouseCallback("Webcog Draw Painting", mouse)
    ...
    while True:
        ...
        cv2.imshow("Webcog Draw Painting", frm)
    ...
    while True:
        ...
        cv2.imshow("", new_frm)
        cv2.imshow("Webcog Draw Painting", mask)
